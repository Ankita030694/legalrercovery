...
const securityHeaders = [
  ...
  },
  {
    ...
    value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://va.vercel-scripts.com; style-src 'self' 'unsafe-inline'; img-src 'self' blob: data: https:; font-src 'self' data:; connect-src 'self' https://va.vercel-scripts.com https://vitals.vercel-insights.com https://secure.payu.in https://*.payu.in; frame-ancestors 'self'; base-uri 'self'; form-action 'self' https://secure.payu.in https://*.payu.in;",
  },
  {
