                ...
                <section id="mediation-and-settlement-deeds" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-slate-650">
                      ...
                      <li>
                        <strong>Keys Handover Protocol:</strong> The deed must link the keys handover to the payment. The tenant should hand over the physical keys to the landlord only **after** the refund amount has successfully cleared in the tenant's bank account. This provides the tenant with maximum leverage.
                      </li>
                      <li>
