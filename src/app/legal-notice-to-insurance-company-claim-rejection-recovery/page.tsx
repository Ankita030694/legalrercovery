...
export const metadata: Metadata = {
  title: "Legal Notice to Insurance Company for Rejected Claim",
  description: "Learn how to recover delayed or rejected insurance claims. Serve a legal notice to the insurer and escalate to the Ombudsman or Consumer Court in India.",
  keywords: [
