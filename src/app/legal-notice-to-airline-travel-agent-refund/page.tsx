...
export const metadata: Metadata = {
  ...
  description: "Learn DGCA flight cancellation refund rules and draft a joint legal notice to recover ticket refunds from travel agents and airlines in India.",
  keywords: [
