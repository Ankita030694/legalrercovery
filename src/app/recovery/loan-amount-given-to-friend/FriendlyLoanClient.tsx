              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="advocate-notices-settlement-strategies" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      The psychological and legal impact of a formal legal notice cannot be overstated. Most borrowers in friendly loan situations have been ignoring informal calls, messages, and requests from the lender for months or years. They assume the lender will &quot;eventually give up&quot; or &quot;not want to spoil the relationship.&quot; When a notice arrives on the letterhead of a law firm, addressed formally, citing specific statutory provisions and threatening civil and criminal action with defined deadlines, the borrower&apos;s calculation changes dramatically. They realize that ignoring the debt now carries tangible legal, financial, and reputational consequences. The notice is typically sent via registered post with acknowledgment due (RPAD) to the borrower&apos;s residential and/or office address, creating an official postal record of delivery. In some cases, we also serve the notice via email and WhatsApp to ensure redundant service.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
