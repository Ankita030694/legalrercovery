                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      **Section 5** of the Payment of Wages Act, 1936, sets strict timelines for salary disbursement:
                      <ul className="list-disc pl-6 space-y-2 mt-2">
                        <li>**Establishments with fewer than 1,000 employees:** Wages must be paid before the expiry of the **seventh (7th) day** of the following month. For example, salary for the month of January must be credited on or before February 7th.</li>
                        <li>**Establishments with 1,000 or more employees:** Wages must be paid before the expiry of the **tenth (10th) day** of the following month (on or before the 10th of the next month).</li>
                        <li>**Termination of employment (Section 5(2)):** When an employee&apos;s service is terminated by the employer, or when an employee resigns, all outstanding wages and dues must be paid within **two (2) working days** of the date of termination or resignation. This requirement overrides any company policy that attempts to hold FNF settlements for 45 or 90 days.</li>
                      </ul>
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
