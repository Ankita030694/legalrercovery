              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="advocate-notices-export-strategy" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      At LegalRecovery, our legal panel drafts custom international notices tailored to the specific details of your export dispute. We do not use generic templates. Instead, we highlight the contract terms, the governing law provisions, the applicability of international conventions, and the personal liability of the company's directors. We send the notice digitally via verified email to the company's registered corporate address, and send copies to the personal email addresses of the directors. Piercing the corporate veil in this manner ensures that the directors are personally aware of the dispute, which often prompts the company's legal team to propose a settlement to protect their management from litigation.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
