              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="cpc-order-37-summary-suits-freelance" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      Under Order 37, the defendant does not have an automatic right to defend the suit. Once the suit is filed, the court issues a specialized summons in Form 4. The defendant must enter an appearance, in person or through an advocate, within **10 days** of receiving the summons. If they fail to do so, the allegations in the plaint are deemed admitted, and the court immediately passes a decree in the freelancer&apos;s favor, allowing for rapid recovery.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                ...
                <section id="cheque-bounce-bns-cheating-remedies" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      The legal procedure for a Section 138 claim has strict statutory timelines. The cheque must be presented to the bank within its 3-month validity period. If dishonored, the bank issues a &quot;Cheque Return Memo.&quot; The freelancer must serve a formal statutory demand notice to the drawer within **30 days** of receiving the return memo, demanding payment of the cheque amount and giving the drawer **15 days** from receipt to clear the dues. If the drawer fails to pay within 15 days, the freelancer must file a criminal complaint in the Magistrate court within **30 days** thereafter.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                ...
                <section id="mandatory-mediation-commercial-courts" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      If a freelance payment dispute involves a claim of **₹3,00,000 (three lakh rupees)** or more and the client is a business entity, the dispute falls under the jurisdiction of the **Commercial Courts Act, 2015**. The Act was enacted to speed up the resolution of commercial disputes and improve India&apos;s business dispute resolution mechanisms. It created specialized Commercial Courts at the district level and Commercial Divisions in High Courts, featuring strict timelines for filing pleadings.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                ...
                <section id="admissibility-digital-evidence-chats" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      To ensure digital evidence is admissible, it must comply with the statutory requirements under Section 63 of the **Bharatiya Nyaya Sanhita, 2023 (BNS)** (formerly Section 65B of the Indian Evidence Act). This requires providing a signed certificate verifying the authenticity of the electronic records. The certificate must state that the computer or phone was operating properly, and that the data was not tampered with. Without this certificate, courts may refuse to admit digital records.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
