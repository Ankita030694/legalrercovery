...
const faqs = [
  {
    question: "What is the timeline to send a legal notice after a cheque bounces in India?",
    answer: "You must send a formal statutory legal notice to the drawer within 30 days of receiving the Cheque Return Memo from your bank. If you miss this 30-day window, you lose the right to file a criminal complaint under Section 138 of the Negotiable Instruments Act, 1881, though civil remedies may still be available."
  },
  {
    question: "How much time does the drawer have to pay after receiving the cheque bounce notice?",
    answer: "Under Section 138 of the NI Act, the drawer has exactly 15 days from the date they receive the legal notice to clear the outstanding cheque amount. The criminal offense is only complete if they fail to make the payment within this 15-day window."
  },
  {
    question: "When should I file a cheque bounce case in court?",
    answer: "If the borrower does not pay within the 15-day notice period, a cause of action arises. You must file a criminal complaint in the Magistrate's Court within 30 days starting from the day the 15-day notice period expires (i.e., between day 16 and day 45 from the receipt of the notice)."
  },
  {
    question: "What is Section 143A of the NI Act, and how does it help the complainant?",
    answer: "Section 143A is an amendment that allows the court to order the drawer to pay interim compensation to the complainant. This compensation can be up to 20% of the cheque amount and is usually ordered during the trial (at the stage of framing charges) to support the lender during litigation."
  },
  {
    question: "What is the penalty for a conviction in a Section 138 cheque bounce case?",
    answer: "If convicted, the drawer can face imprisonment for up to two (2) years, a fine of up to double the cheque amount (which the court can award to you as compensation), or both. This criminal penalty makes cheque bounce actions a highly effective recovery tool."
  },
  {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://www.legalrecovery.in/recovery/cheque-bounce-amount"
    }
  ]
};
...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Recovering Bounced Cheque Amount under Section 138 NI Act: Timelines & Remedies",
  "description": "Comprehensive legal guide on recovering outstanding money after a cheque bounce in India. Follow step-by-step notice timelines, interim compensation claims, and summary suits.",
  "image": "https://www.legalrecovery.in/og-cheque-bounce-recovery.png",
  "author": {
    "@type": "Organization",
...
const reviewSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  "name": "Cheque Bounce Legal Recovery Services",
  "image": "https://www.legalrecovery.in/og-cheque-bounce-recovery.png",
  "description": "Professional legal services for recovering outstanding dues after a cheque bounce under Section 138 NI Act in India.",
  "brand": {
    "@type": "Brand",
    "name": "LegalRecovery"
  },
  ...
  "review": [
    {
      ...
      "reviewBody": "I had a business cheque of ₹8 Lakhs bounce due to 'insufficient funds'. LegalRecovery guided me through the Section 138 timeline, served a notice, and the vendor cleared it before we went to court. Exceptional service!"
    },
    {
      "@type": "Review",
      "reviewRating": {
      ...
      "reviewBody": "A client gave me a post-dated cheque for ₹3.5 Lakhs that bounced. LegalRecovery's advocate drafted and sent the statutory notice within 10 days of the bounce. The client paid immediately with interest. Highly recommend."
    },
    {
      "@type": "Review",
      "reviewRating": {
      ...
      "reviewBody": "I recovered my loan of ₹10 Lakhs through LegalRecovery. They filed both the Section 138 NI Act case and a Summary Suit under CPC Order 37. We also secured 20% interim compensation under Section 143A. Brilliant execution!"
    },
    {
      "@type": "Review",
      "reviewRating": {
      ...
      "reviewBody": "Excellent platform. They monitored the post-office tracking of the notice delivery and prepared all filings quickly. The borrower settled the bounced cheque amount of ₹4.5 Lakhs within 15 days."
    },
    {
      "@type": "Review",
      "reviewRating": {
    ...
    },
    {
      ...
      "reviewBody": "Very professional drafting. We sent notices to the company directors as well, which pushed them to clear the bounced cheque of ₹12 Lakhs within three weeks of delivery."
    }
  ]
};

export default function ChequeBounceAmountClient() {
  ...
  const tocSections = [
    { id: "statutory-understanding-cheque-bounce", title: "Dishonour Analysis" },
    { id: "mandatory-timelines-recovery-cheque", title: "NI Act Timelines" },
    { id: "drafting-statutory-bounce-notice", title: "Notice Strategy" },
    { id: "filing-complaint-magistrate-court", title: "Magistrate Filings" },
    { id: "parallel-civil-remedies-cpc", title: "Summary Suits (Order 37)" },
    { id: "penalties-interim-compensation-rules", title: "Interim Pay & Penalties" },
    { id: "cheque-bounce-recovery-case-studies", title: "Success Stories" },
    { id: "cheque-bounce-verified-testimonials", title: "Client Reviews" },
    { id: "why-choose-legalrecovery-cheque-claims", title: "Why LegalRecovery" },
    { id: "faqs", title: "FAQs" }
  ];

  const breadcrumbItems = [
    { label: "Recovery", href: "/recovery" },
    { label: "Cheque Bounce Recovery", href: "/recovery/cheque-bounce-amount" }
  ];
        ...
        <div className="relative bg-gradient-to-br from-[#111827] via-[#0F172A] to-[#020617] text-white overflow-hidden py-24 md:py-44 border-b border-slate-900">
          ...
          <div className="relative z-20 container mx-auto px-4 text-center">
            ...
            <h1 className="text-3xl md:text-6xl font-black mb-6 leading-tight tracking-tight">
              Is a Repayment <span className="text-[#DC2626]">Cheque Bounced</span> or Dishonored?
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr_280px] xl:grid-cols-[280px_1fr_300px] gap-8 xl:gap-10 items-start mt-6">
              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="statutory-understanding-cheque-bounce" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      The Supreme Court of India has consistently ruled that the objective of Section 138 is to provide a fast recovery mechanism and penalize dishonest transactions. In landmark rulings such as <strong>Dalmia Cement (Bharat) Ltd. v. Galaxy Traders &amp; Agencies Ltd. (2001)</strong>, the apex court clarified that the legislative intent was to enhance the credibility of negotiable instruments and promote efficiency in business activities.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                    ...
                    <div className="bg-red-50 p-6 rounded-2xl border-l-4 border-[#DC2626] italic text-xs sm:text-sm text-red-900 font-semibold leading-relaxed">
                      &quot;A bounced cheque is a criminal offense under Section 138. The law provides strict timelines to initiate legal actions, which, if followed correctly, yield fast-track recovery decrees and compensation.&quot;
                    </div>
                  </div>
                </section>

                {/* Section 2: Mandatory Timelines and Steps under Section 138 NI Act */}
                <section id="mandatory-timelines-recovery-cheque" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-black text-slate-900 mb-5 border-b-2 border-[#DC2626] pb-2 inline-block">
                ...
                {/* Section 3: Drafting and Serving the 30-Day Statutory Demand Notice */}
                <section id="drafting-statutory-bounce-notice" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-black text-slate-900 mb-5 border-b-2 border-[#DC2626] pb-2 inline-block">
                ...
                {/* Section 4: Initiating Criminal Complaints before the Magistrate */}
                <section id="filing-complaint-magistrate-court" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-black text-slate-900 mb-5 border-b-2 border-[#DC2626] pb-2 inline-block">
                ...
                {/* Section 5: Parallel Civil Recovery: Summary Suits under Order 37 */}
                <section id="parallel-civil-remedies-cpc" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-black text-slate-900 mb-5 border-b-2 border-[#DC2626] pb-2 inline-block">
                ...
                {/* Section 6: Penalties, Conviction, and Section 143A Interim Compensation */}
                <section id="penalties-interim-compensation-rules" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-black text-slate-900 mb-5 border-b-2 border-[#DC2626] pb-2 inline-block">
                ...
                {/* Section 7: Cheque Bounce Recovery Case Studies & Precedents */}
                <section id="cheque-bounce-recovery-case-studies" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-black text-slate-900 mb-5 border-b-2 border-[#DC2626] pb-2 inline-block">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                      <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                        <span className="text-[#DC2626] text-xs font-black uppercase tracking-wider">Case Study 1: Business Invoice Payment</span>
                        <h4 className="font-extrabold text-sm text-slate-900 mt-2 mb-3">Recovered ₹8 Lakhs from Vendor</h4>
                      ...
                      <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                        <span className="text-[#DC2626] text-xs font-black uppercase tracking-wider">Case Study 2: Personal Loan Cheque Recovery</span>
                        <h4 className="font-extrabold text-sm text-slate-900 mt-2 mb-3">Recovered ₹5 Lakhs with 20% Interim Relief</h4>
                        <p className="text-xs text-slate-600 leading-relaxed">
                ...
                {/* Section 8: Verified Client Testimonials for Cheque Bounce Recovery */}
                <section id="cheque-bounce-verified-testimonials" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-black text-slate-900 mb-5 border-b-2 border-[#DC2626] pb-2 inline-block">
                ...
                {/* Section 9: Why Partner with LegalRecovery for Cheque Bounce Claims */}
                <section id="why-choose-legalrecovery-cheque-claims" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-black text-slate-900 mb-5 border-b-2 border-[#DC2626] pb-2 inline-block">
            ...
            <div className="space-y-8 sticky top-24">
              ...
              <div className="bg-[#111827] p-6 rounded-2xl shadow-sm text-white border border-slate-800 relative overflow-hidden">
                ...
                <h3 className="text-sm font-black mb-3">Recover Bounced Cheque</h3>
