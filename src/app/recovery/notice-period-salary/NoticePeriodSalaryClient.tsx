                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      ...
                      <ul className="list-disc pl-6 space-y-2 mt-2">
                        <li>**Minimum Notice Period:** Employers must provide at least **one (1) month&apos;s notice in writing** or **one month&apos;s wages in lieu of notice** to any employee who has completed continuous service of a specified duration (typically three to six months, depending on the state).</li>
                        <li>**Reason for Termination:** The employer must state a reasonable cause for termination in the written notice. Immediate termination without notice or notice pay is permitted only in cases of proven misconduct.</li>
                        <li>**Probation Period Rules:** During the probation period, the notice period is governed by the appointment letter, but state laws still require a reasonable notice window (typically 15 days) or equivalent wages if the probation is terminated early.</li>
                      </ul>
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
