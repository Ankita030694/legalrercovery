                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      ...
                      <ul className="list-disc pl-6 space-y-2 mt-2">
                        <li>**Daily and Weekly Limits:** Most state acts define standard working hours as 8 to 9 hours a day, and 48 hours a week. Any hours worked beyond these limits must be treated as overtime.</li>
                        <li>**Double Rate Mandate:** State laws require overtime hours to be compensated at **double the regular wage rate** (2x the ordinary rate of wages).</li>
                        <li>**Holiday and Off-Day Work:** Working on weekly offs or declared national holidays also entitles the employee to double-rate pay or a compensatory off-day along with standard pay.</li>
                      </ul>
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                ...
                <section id="wrongful-denial-misclassification" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      ...
                      <ul className="list-disc pl-6 space-y-2 mt-2">
                        <li>**Unrecorded Overtime:** Forcing employees to log out of biometric systems at the end of their shift but continue working, or demanding work via email or Slack after standard working hours.</li>
                        <li>**One-Sided Clauses:** Including clauses in employment contracts stating that overtime is &quot;voluntary&quot; or &quot;not compensated.&quot; Such clauses violate public policy and are legally void.</li>
                        <li>**Biometric Manipulation:** Altering attendance records in company database systems to show standard working hours instead of the actual hours worked.</li>
                      </ul>
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                ...
                <section id="advocate-notices-evidence-strategy" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      ...
                      <ul className="list-disc pl-6 space-y-2 mt-2">
                        <li>**Biometric Logs:** Exported records showing your clock-in and clock-out times.</li>
                        <li>**Digital Communications:** Email trails, Slack, Microsoft Teams, or WhatsApp chat logs showing management demanding work after standard hours or during holidays.</li>
                        <li>**Work Deliverables:** Git commits, document edits, or system login logs that prove you were actively working during those overtime hours.</li>
                        <li>**Timesheets:** Approved timesheets or project status reports submitted to clients or managers.</li>
                      </ul>
