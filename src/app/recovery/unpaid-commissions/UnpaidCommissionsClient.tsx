            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="cpc-order-37-summary-suits-commissions" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      A major concern for agents and brokers is the potential delay in the civil court system. Regular civil recovery suits can take years, making them impractical for recovering outstanding commissions. However, the Code of Civil Procedure, 1908, provides a fast-track remedy under **Order XXXVII (Summary Suits)**. This procedure is designed for the rapid recovery of liquidated debts arising from written contracts, which include brokerage agreements, commission structures, and payout invoices.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      Under Order 37, the defendant does not have an automatic right to defend the suit. Once the suit is filed, the court issues a specialized summons in Form 4. The defendant must enter an appearance, in person or through an advocate, within **10 days** of receiving the summons. If they fail to do so, the allegations in the plaint are deemed admitted, and the court immediately passes a decree in the agent&apos;s favor, allowing for rapid recovery.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                ...
                <section id="cheque-bounce-criminal-breach-trust-commissions" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      Principals sometimes issue cheques to agents for commission payments that are subsequently dishonored. Under **Section 138 of the Negotiable Instruments (NI) Act, 1881**, issuing a cheque that bounces due to &quot;insufficient funds&quot; or &quot;stop payment&quot; instructions is a criminal offense. The criminal nature of cheque bounce proceedings provides significant leverage, as it exposes the corporate directors to personal prosecution, arrest warrants, and criminal records.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      The legal procedure for a Section 138 claim has strict statutory timelines. The cheque must be presented to the bank within its 3-month validity period. If dishonored, the bank issues a &quot;Cheque Return Memo.&quot; The agent must serve a formal statutory demand notice to the drawer within **30 days** of receiving the return memo, demanding payment of the cheque amount and giving the drawer **15 days** from receipt to clear the dues. If the drawer fails to pay within 15 days, the agent must file a criminal complaint in the Magistrate court within **30 days** thereafter.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                ...
                <section id="mandatory-mediation-commercial-courts-commissions" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      If a commission payment dispute involves a claim of **₹3,00,000 (three lakh rupees)** or more and the principal is a business entity, the dispute falls under the jurisdiction of the **Commercial Courts Act, 2015**. The Act was enacted to speed up the resolution of commercial disputes and improve India&apos;s business dispute resolution mechanisms. It created specialized Commercial Courts at the district level and Commercial Divisions in High Courts, featuring strict timelines for filing pleadings.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
