            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="mediclaim-reimbursement-landscape" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      Health insurance in India, commonly referred to as mediclaim, operates through two primary settlement mechanisms: <strong>Cashless Facility</strong> and <strong>Reimbursement claims</strong>. The cashless facility allows policyholders to receive medical treatment at network hospitals without paying the bill out of pocket, as the insurer coordinates payment directly with the hospital through a Third Party Administrator (TPA). However, this cashless facility is a provisional pre-authorization process based on initial diagnosis and estimates. If pre-authorization is denied or if the treatment is received at a non-network hospital, the customer must pay the hospital directly and submit a <strong>Reimbursement Claim</strong> post-discharge.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                ...
                <section id="evidence-and-precedents" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      Resolving insurance disputes relies on the quality of the evidence compiled. Under the <strong>Bharatiya Sakshya Adhiniyam (BSA), 2023</strong>, specifically <strong>Section 63</strong> (which replaced Section 65B of the Indian Evidence Act), any digital records (such as PDF medical bills, scan reports, email threads, or digital doctor notes) must be accompanied by a formal <strong>Digital Certificate</strong>.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
