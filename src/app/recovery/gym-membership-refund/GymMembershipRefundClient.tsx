            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="legal-notice" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      A legal notice is the formal bridge between administrative complaints and courtroom litigation. It is a document drafted and signed by your advocate, served digitally via verified email to the gym&apos;s registered office, that puts the gym on record that legal proceedings will be initiated if your demands are not met within a specified window (typically 15 days from the date of receipt). While a legal notice is not a mandatory prerequisite for filing a consumer complaint, it serves multiple critical strategic purposes.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
