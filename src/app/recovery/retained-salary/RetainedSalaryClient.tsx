            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="statutory-framework-retained-wages" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      The primary legislative shield protecting employees against unauthorized salary deductions and retention policies is the **Payment of Wages Act, 1936**. The Act was enacted to ensure that employers pay wages on time and do not make arbitrary deductions. Under Section 3 of the Act, every employer is personally responsible for the payment of all wages required to be paid under the Act to persons employed by him. Any system where the employer routinely holds back a portion of the basic salary or allowances is a direct violation of the Act&apos;s core purpose.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      Under **Section 7** of the Payment of Wages Act, 1936, the wages of an employed person must be paid to him without deductions of any kind except those authorized by or under the Act. Section 7 provides an exhaustive list of permissible deductions, such as deductions for taxes, EPF contributions, or recovery of advances. Crucially, &quot;salary retention for performance&quot; or &quot;talent retention withholding&quot; is **not** a permissible deduction under Section 7. Any contract clause that permits the employer to deduct or retain salary for these reasons is legally void to that extent.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      Furthermore, **Section 5** of the Act mandates the timely payment of wages. It states that the wages of every person employed in any establishment must be paid before the expiry of the seventh day (for establishments with fewer than 1,000 employees) or tenth day (for larger establishments) after the last day of the wage period. If an employee resigns or is terminated, Section 5(2) requires the employer to clear all outstanding wages within two working days of termination. Holding back the retained salary for months after resignation directly violates this statutory timeline.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      In addition to the Payment of Wages Act, the **Code on Wages, 2019**, which consolidates and replaces previous wage-related laws, reinforces the employer&apos;s obligation to pay wages on time and limits deductions to a maximum of 50% of the total wages in any month. The Code strictly prohibits any unauthorized withholding of wages. The principles of the Code on Wages can be used by our legal team to show that the employer&apos;s salary retention practices are unlawful and constitute a statutory violation, regardless of the employee&apos;s title or salary.
                    </p>
                  </div>
                </section>
                ...
                <section id="summary-suits-order-37-retention" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      For managerial, administrative, and executive-level employees who do not fall under the definition of &quot;workmen&quot; under labor laws, the primary civil court remedy is a **Summary Suit under Order XXXVII of the CPC**. Regular civil suits in India are notoriously slow, taking years to resolve, as defendants can delay trials by filing lengthy written statements and seeking multiple adjournments. Order 37 bypasses these delays by introducing a fast-track procedure where the defendant does not have an automatic right to contest the suit. It applies to suits for the recovery of a liquidated debt arising on a written contract.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      The procedural steps of a Summary Suit are strictly timed. Upon filing, the court issues a specialized summons in Form 4 to the employer. The employer must enter an appearance, in person or through an advocate, within **10 days** of receiving the summons. If they fail to do so, the allegations in the plaint are deemed admitted, and the court immediately passes a decree in the employee&apos;s favor, allowing for rapid recovery.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      If the employer enters an appearance, the employee serves a &quot;Summons for Judgment.&quot; The employer then has 10 days to file an application for **&quot;Leave to Defend&quot;**. To obtain leave, the employer must convince the court through an affidavit that they have a substantial and bona fide defense, rather than a sham or delay tactic. If the court finds the defense is a mere delay tactic (for example, admitting they withheld the salary but claiming the employee resigned before the milestone date), it will deny leave and pass a decree, or grant &quot;conditional leave&quot; requiring the employer to deposit a portion of the disputed amount into court.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                ...
                <section id="criminal-remedies-breach-of-trust-retention" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      Under **Section 316 of the Bharatiya Nyaya Sanhita, 2023 (BNS)** (formerly Section 406 of the IPC), **Criminal Breach of Trust** is defined as dishonestly misappropriating or converting to one&apos;s own use any property entrusted to a person, or dishonestly using or disposing of that property in violation of any direction of law. Wages earned by an employee are held in trust by the employer until payout. If the employer deducts retention amounts from your monthly pay and then dishonestly refuses to pay them out, they commit a criminal breach of trust, which carries a penalty of up to three years of imprisonment.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
