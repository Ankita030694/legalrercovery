...
const faqs = [
  ...
  },
  {
    ...
    answer: "You must build a clear digital trail. This includes: the original booking form, payment receipts, bank statement entries showing the debit, the formal cancellation request email sent to the builder, the builder's written acknowledgment of cancellation (if any), and copies of follow-up communications."
  },
  {
