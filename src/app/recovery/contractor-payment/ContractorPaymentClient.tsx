            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="breach-of-contract-protections" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      For contractors who are not registered under the MSMED Act (such as larger enterprise contractors or firms without Udyam registration), the recovery of unpaid dues is governed by the provisions of the <strong>Indian Contract Act, 1872</strong>. A contractor agreement, backed by a Purchase Order (PO) or Work Order (WO), is a legally binding contract. When a client accepts your services or takes possession of project works but refuses to pay the agreed invoices, they commit a fundamental <strong>breach of contract</strong>. This breach gives the contractor the legal right to claim the outstanding principal along with interest and damages.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      Under <strong>Section 73</strong> of the Indian Contract Act, 1872, the party who suffers from a breach of contract is entitled to receive compensation for any loss or damage caused to them by the breach. In contractor disputes, these damages include:
                      <ul className="list-disc pl-6 space-y-2 mt-2">
                        <li><strong>Outstanding Invoice Value:</strong> The unpaid principal amount for work completed and accepted.</li>
