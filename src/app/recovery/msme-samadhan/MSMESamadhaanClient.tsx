              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="msme-advocate-notices-samadhan-strategy" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      At LegalRecovery, our legal panel drafts custom notices tailored to your specific transaction. We include detailed interest calculations and reference your Udyam Certificate, leaving no room for the buyer to claim ignorance. We digitally dispatch the notice via verified email and WhatsApp to the company's registered corporate office, and send copies to the personal residential addresses of the directors. Piercing the corporate veil in this manner ensures that the directors are personally aware of the dispute, which often prompts the company's legal team to propose a settlement to protect their management from litigation.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
