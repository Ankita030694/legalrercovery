              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="ugc-refund-slabs" className="scroll-mt-32">
                  ...
                  <div className="space-y-5 text-sm md:text-base text-slate-650 leading-relaxed">
                    ...
                    <p>
                      The critical procedural requirement is that your withdrawal application must be <strong>in writing</strong> and submitted to the institution formally—not communicated verbally, not sent through an intermediary, and not merely implied by the fact that you stopped attending classes. The date on which the institution receives your written withdrawal application is the trigger date for the refund slab calculation. We always advise clients to submit withdrawal applications via email to the admissions office and the registrar simultaneously, and in-person submission with an acknowledgment copy stamped by the institution. This dual-channel submission ensures that the trigger date is irrefutably established.
                    </p>
                    <p>
                ...
                <section id="legal-notice-forum" className="scroll-mt-32">
                  ...
                  <div className="space-y-5 text-sm md:text-base text-slate-650 leading-relaxed">
                    ...
                    <p>
                      The notice is served digitally via verified email and WhatsApp to the college&apos;s registered address and the personal residential addresses of all trustees, directors, and the principal. The personal addressing of trustees is a deliberate and highly effective tactic: it creates personal legal exposure for individuals who often insulate themselves from institutional disputes by hiding behind the college&apos;s organisational structure. A trustee who receives a notice—citing their personal liability under the Consumer Protection Act and requesting a response within 15 days—has a very different relationship to the dispute than a trustee who is blissfully unaware that a grievance exists at the institutional level. In approximately 65–70% of our cases, the college settles at this stage.
                    </p>
                    <p>
