...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Recovering Unpaid International Client Payment & Invoices | Legal Recovery Guide",
...
export default function InternationalClientPaymentClient() {
  ...
  const tocSections = [
    { id: "international-client-payment-overview", title: "Overview of International Client Payment" },
        ...
        <div className="relative bg-gradient-to-br from-[#111827] via-[#0F172A] to-[#020617] text-white overflow-hidden py-24 md:py-44 border-b border-slate-900">
          ...
          <div className="relative z-20 container mx-auto px-4 text-center">
            ...
            <h1 className="text-3xl md:text-6xl font-black mb-6 leading-tight tracking-tight">
              Recover Outstanding <span className="text-[#DC2626]">International Client Payment</span> &amp; Invoices
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-8 items-start mt-6">
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                {/* Section 1: Overview of International Client Payment */}
                <section id="international-client-payment-overview" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-black text-slate-900 mb-5 border-b-2 border-[#DC2626] pb-2 inline-block">Overview of International Client Payment</h2>
