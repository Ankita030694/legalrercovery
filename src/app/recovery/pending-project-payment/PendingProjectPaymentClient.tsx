            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="contract-law-sow-protections" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    <p className="text-sm md:text-base leading-relaxed">
                      A project-based transaction is governed by the provisions of the **Indian Contract Act, 1872**. The primary document defining the project scope, timelines, milestones, and payment terms is the **Statement of Work (SOW)** or **Service Level Agreement (SLA)**. This document is a legally binding contract. When a client accepts your services or takes possession of project deliverables but refuses to disburse the agreed milestone payments, they commit a fundamental **breach of contract**. This breach gives the contractor the legal right to claim the outstanding principal along with interest and damages.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      Under **Section 73** of the Indian Contract Act, 1872, the party who suffers from a breach of contract is entitled to receive compensation for any loss or damage caused to them by the breach. In project disputes, these damages include:
                      <ul className="list-disc pl-6 space-y-2 mt-2">
                        <li>**Outstanding Milestone Value:** The unpaid principal amount for work completed and accepted.</li>
