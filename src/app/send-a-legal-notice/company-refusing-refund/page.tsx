...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://legalrecovery.in/send-a-legal-notice/company-refusing-refund',
  },
  openGraph: {
    ...
    url: 'https://legalrecovery.in/send-a-legal-notice/company-refusing-refund',
    type: 'article',
    ...
    images: [
      {
        url: 'https://legalrecovery.in/images/og/company-refusing-refund.jpg',
        width: 1024,
        height: 1024,
  ...
  twitter: {
    ...
    images: ['https://legalrecovery.in/images/og/company-refusing-refund.jpg'],
  },
};
