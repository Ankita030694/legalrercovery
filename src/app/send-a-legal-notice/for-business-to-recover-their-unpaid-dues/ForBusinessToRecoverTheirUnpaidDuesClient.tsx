              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-100 pb-4 gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() => window.open('https://twitter.com/intent/tweet?url=https%3A%2F%2Flegalrecovery.in%2Fsend-a-legal-notice%2Ffor-business-to-recover-their-unpaid-dues&text=Recover%20unpaid%20business%20dues%20and%20overdue%20B2B%20invoices%20with%20a%20statutory%20legal%20notice!%20%23BusinessRecovery%20%23DebtRecovery', '_blank', 'noopener,noreferrer')}
                    ...
                    <button
                      type="button"
                      onClick={() => window.open('https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Flegalrecovery.in%2Fsend-a-legal-notice%2Ffor-business-to-recover-their-unpaid-dues', '_blank', 'noopener,noreferrer')}
                    ...
                    <button
                      type="button"
                      onClick={() => window.open('https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Flegalrecovery.in%2Fsend-a-legal-notice%2Ffor-business-to-recover-their-unpaid-dues&title=Legal%20Notice%20for%20Business%20to%20Recover%20Their%20Unpaid%20Dues', '_blank', 'noopener,noreferrer')}
                ...
                <section id="statutory-framework" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      For registered micro, small, and medium enterprises holding a valid Udyam Registration, the primary statutory shield is the <span className="font-semibold text-slate-800">Micro, Small and Medium Enterprises Development (MSMED) Act, 2006</span>. Under Section 15 of the MSMED Act, buyers are bound by a statutory mandate to clear payments within the agreed credit window, which cannot exceed 45 days under any circumstances. In the event of default, Section 16 imposes a mandatory penal interest rate calculated as compound interest with monthly rests at three times the <span className="font-semibold text-slate-800">Reserve Bank of India (RBI)</span> Bank Rate. Creditors can file statutory recovery references before the Micro and Small Enterprise Facilitation Council (MSEFC) through the <span className="font-semibold text-slate-800">MSME Samadhaan Portal</span>, where council arbitral awards hold the executable force of a civil court decree.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      For corporate and general commercial debts, creditors utilize the fast-track mechanism of a Commercial Summary Suit under Order XXXVII of the <span className="font-semibold text-slate-800">Code of Civil Procedure, 1908 (CPC)</span>. Governed by the <span className="font-semibold text-slate-800">Commercial Courts Act, 2015</span>, summary suits apply to liquidated debts arising from written contracts, purchase orders, bills of exchange, or unpaid invoices. Under Order XXXVII, the defendant debtor does not possess an automatic right to defend the suit; they must obtain leave to defend from the court by demonstrating a bona fide, non-frivolous triable defense. If the court denies leave or the debtor defaults, the court enters an immediate money decree in favor of the creditor business.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
                      Where defaulting buyers attempt to discharge commercial debts through negotiable instruments that subsequent bounce, Section 138 of the <span className="font-semibold text-slate-800">Negotiable Instruments Act, 1881</span> and Section 25 of the <span className="font-semibold text-slate-800">Payment and Settlement Systems Act, 2007</span> establish strict criminal liability. In cases of corporate debtor default exceeding ₹1 Crore, operational creditors can serve a mandatory Form 3 or Form 4 demand notice under Section 8 of the <span className="font-semibold text-slate-800">Insolvency and Bankruptcy Code, 2016 (IBC)</span> and initiate Corporate Insolvency Resolution Processes (CIRP) under Section 9 before the National Company Law Tribunal (NCLT). Serving a formal advocate legal demand notice is the mandatory pre-condition that establishes the uncontroverted record of commercial default across all these forums.
                    </p>
                  </div>
                </section>
                    ...
                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs sm:text-sm text-slate-650 leading-relaxed mt-1">
                            Manufacturers, raw material suppliers, distributors, and wholesalers supplying goods on agreed 15, 30, or 45-day credit terms. Defaults occur when buyers accept delivery without raising quality objections within the inspection window but subsequently withhold invoice payments. Notices enforce the unpaid seller&apos;s rights under the <span className="font-semibold text-slate-800">Sale of Goods Act, 1930</span> alongside GST e-invoice and e-way bill records.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs sm:text-sm text-slate-650 leading-relaxed mt-1">
                            Software development agencies, marketing firms, management consultants, and professional service providers executing deliverables under Master Service Agreements (MSAs) or Statements of Work (SOWs). Defaults occur when clients deploy software code or approved deliverables but refuse to release sign-off milestone retainers. Notices demand immediate release of dues under Section 70 of the <span className="font-semibold text-slate-800">Indian Contract Act, 1872</span>.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                      ...
                      <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm">
                        ...
                        <ul className="text-xs sm:text-sm text-slate-650 space-y-2 list-disc list-inside">
                          ...
                          <li><span>MCA Company Master Data, DIN details, and registered office address</span></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                ...
                <section id="post-notice-escalation" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 space-y-4">
                      ...
                      <p className="text-xs sm:text-sm text-slate-700 leading-relaxed font-medium">
                        <strong>2. Commercial Summary Suit (Order XXXVII CPC):</strong> File a summary money suit in the competent Commercial Court via the <span className="font-semibold text-slate-800">e-Courts Commercial Portal</span>. The debtor must demonstrate a genuine defense to defend the suit, enabling creditors to obtain swift money decrees without protracted multi-year trials.
                      </p>
                      <p className="text-xs sm:text-sm text-slate-700 leading-relaxed font-medium">
                ...
                <div className="pt-8 border-t border-slate-100">
                  <p className="text-xs text-slate-400">
                    References: [1] <a href="https://msme.gov.in/" target="_blank" rel="nofollow noopener noreferrer" className="text-purple-600 hover:text-purple-800 hover:underline">Micro, Small and Medium Enterprises Development (MSMED) Act, 2006 (Sections 15-18)</a>. [2] <span className="text-slate-600">Code of Civil Procedure, 1908 (Order XXXVII Commercial Summary Suits)</span>. [3] <span className="text-slate-600">Commercial Courts Act, 2015 (Pre-Institution Mediation and Commercial Jurisdiction)</span>. [4] <span className="text-slate-600">Negotiable Instruments Act, 1881 (Section 138 Cheque Dishonor)</span>. [5] <span className="text-slate-600">Insolvency and Bankruptcy Code, 2016 (Sections 8 &amp; 9 Operational Creditor Demands)</span>. [6] <span className="text-slate-600">Indian Contract Act, 1872 (Breach of Contract &amp; Quantum Meruit)</span>. [7] <a href="https://samadhaan.msme.gov.in/" target="_blank" rel="nofollow noopener noreferrer" className="text-purple-600 hover:text-purple-800 hover:underline">MSME Samadhaan Portal for Delayed Payment Recovery</a>.
                  </p>
                </div>
              </div>
            </div>
