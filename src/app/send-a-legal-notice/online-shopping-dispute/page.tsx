...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.legalrecovery.in/send-a-legal-notice/online-shopping-dispute',
    type: 'article',
    ...
    images: [
      {
        url: 'https://www.legalrecovery.in/images/og/online-shopping-dispute.jpg',
        width: 1024,
        height: 1024,
  ...
  twitter: {
    ...
    images: ['https://www.legalrecovery.in/images/og/online-shopping-dispute.jpg'],
  },
};
