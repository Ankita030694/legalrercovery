              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-100 pb-4 gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() => window.open("https://twitter.com/intent/tweet?url=https%3A%2F%2Fwww.legalrecovery.in%2Fsend-a-legal-notice%2Fzomato-refund-not-recieved&text=Complete%20legal%20guide%20to%20sending%20a%20legal%20notice%20for%20a%20Zomato%20refund%20not%20received%20under%20the%20Consumer%20Protection%20Act.%20%23ConsumerRights", "_blank", "noopener,noreferrer,width=600,height=400")}
                      className="w-8 h-8 rounded-full bg-black text-white hover:opacity-80 flex items-center justify-center transition-opacity cursor-pointer border-none"
                    ...
                    <button
                      type="button"
                      onClick={() => window.open("https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.legalrecovery.in%2Fsend-a-legal-notice%2Fzomato-refund-not-recieved", "_blank", "noopener,noreferrer,width=600,height=400")}
                      className="w-8 h-8 rounded-full bg-[#1877F2] text-white hover:opacity-80 flex items-center justify-center transition-opacity cursor-pointer border-none"
                    ...
                    <button
                      type="button"
                      onClick={() => window.open("https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fwww.legalrecovery.in%2Fsend-a-legal-notice%2Fzomato-refund-not-recieved&title=Legal%20Notice%20for%20Zomato%20Refund%20Not%20Received", "_blank", "noopener,noreferrer,width=600,height=400")}
                      className="w-8 h-8 rounded-full bg-[#0A66C2] text-white hover:opacity-80 flex items-center justify-center transition-opacity cursor-pointer border-none"
                ...
                <div className="pt-8 border-t border-slate-100 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs text-slate-600">
                    ...
                    <span>&bull;</span>
                    <span>Ministry of Consumer Affairs &ndash; E-Commerce Rules 2020</span>
                    <span>&bull;</span>
                    <span>e-Daakhil Consumer Grievance Filing System</span>
                    <span>&bull;</span>
                    <span>India Code &ndash; Consumer Protection Act, 2019</span>
                    <span>&bull;</span>
                    <span>Reserve Bank of India (RBI) Failed Transaction TAT Rules</span>
                    <span>&bull;</span>
