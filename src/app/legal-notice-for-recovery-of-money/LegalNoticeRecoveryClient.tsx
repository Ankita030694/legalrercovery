              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="dispatch-validity" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      The most secure method of serving a notice is digitally via <strong>verified email and WhatsApp</strong>. This method provides a digital dispatch receipt containing a tracking status. Once delivered, you receive a delivery report. In many cases, a dishonest debtor may intentionally evade service. Creditors often panic in such situations, thinking the notice has failed. However, under the law, if a notice is properly addressed and dispatched, the court will presume that delivery has been effected. Evading service is treated as constructive service, meaning the law deems it as served, and the debtor cannot claim ignorance in court.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
