              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="udyam-registration-msme-samadhaan" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    ...
                    <p>
                      The most lethal tool in the MSME arsenal is the **Interest Clause** under **Section 16**. If the buyer delays payment, they are legally liable to pay the MSE compound interest with monthly rests on the outstanding amount. The interest rate is fixed at **three times the bank rate** notified by the Reserve Bank of India (RBI). In practice, this rate can range from 18% to 22% per annum. Furthermore, under Section 19, if the client wishes to appeal an award passed by the MSEFC in court, they must first deposit **75% of the awarded amount** in court. This financial penalty makes corporate clients highly eager to settle MSE disputes during the initial notice or conciliation phase.
                    </p>
                  </div>
                </section>
                ...
                <section id="criminal-remedies-cheating-ni-act" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    ...
                    <p>
                      The first criminal pathway relates to a **bounced cheque**. If a client issues a cheque to clear your outstanding invoice and it is returned by the bank as &quot;Insufficient Funds&quot; or &quot;Refer to Drawer,&quot; this constitutes a criminal offense under <strong>Section 138 of the Negotiable Instruments Act, 1881</strong>. The law mandates a strict statutory timeline:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-slate-650">
                      <li>
                        The freelancer must send a formal demand notice to the drawer within **30 days** of receiving the bank memo.
                      </li>
                      <li>
                        The notice must demand payment of the cheque amount, giving the drawer exactly **15 days** from the receipt of the notice to clear the dues.
                      </li>
                      <li>
                        If the client fails to pay within those 15 days, the cause of action arises, and the freelancer can file a criminal complaint in the Magistrate Court within **30 days**.
                      </li>
                    </ul>
                    <p>
                      The second criminal option is filing a complaint for **Cheating and Dishonestly Inducing Delivery of Property** under <strong>Section 318 of the BNS, 2023</strong> (formerly Section 420 of the IPC) and **Criminal Breach of Trust** under <strong>Section 316 BNS</strong> (formerly Section 406 IPC). To make a criminal cheating charge stick, you must prove that the client had dishonest or fraudulent intent from the very inception of the contract (i.e. they hired you with the clear intention of never paying you).
                    </p>
                    <p>
                ...
                <section id="evidence-preservation-digital-notices" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    ...
                    <p>
                      Under Section 63, electronic evidence must be accompanied by a signed **Section 63 BSA Certificate**. This certificate must identify the electronic record, describe the device used to print or copy it, verify that the device was operating properly during the relevant period, and include cryptographic hash values (such as SHA-256) of the files to prove they have not been altered. Failing to attach this certificate renders your digital evidence inadmissible.
                    </p>
                ...
                <section id="settlement-deed-drafting" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    ...
                    <p>
                      The Settlement Deed must be structured carefully to protect your interests. The first essential clause is a **Payment Schedule**. If the client is paying in installments, the deed must specify the exact dates, installment amounts, and the beneficiary bank details. The second clause is a **Default Clause**, stating that if the client misses any installment, the entire settlement is void, and the original claim amount along with accrued interest immediately becomes due and payable.
                    </p>
                    <p>
                      The third clause is the **Intellectual Property Release**. As a freelancer, you hold the IP rights to your work. The deed must specify that ownership of all code, designs, or marketing assets is only transferred to the client upon the **receipt of the final payment** in your bank account. This prevents the client from using your work while defaulting on the settlement.
                    </p>
                    <div className="bg-red-50 p-6 rounded-2xl border-l-4 border-[#DC2626] italic text-xs sm:text-sm text-red-900 font-semibold leading-relaxed">
