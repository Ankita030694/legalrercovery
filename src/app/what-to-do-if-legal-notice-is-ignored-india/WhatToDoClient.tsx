            ...
            <article className="min-w-0 bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
              ...
              <section id="debunking-myths" className="scroll-mt-32">
                ...
                <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                  ...
                  <p className="text-sm md:text-base leading-relaxed">
                    This creates a powerful, rebuttable presumption of law. If a cunning debtor instructs their staff to reject any registered mail from your lawyer, or if they personally tell the postman "Return to Sender", they have practically shot themselves in the foot. When the postal department returns the envelope with the endorsement "Refused," the Indian courts unanimously rule that the notice is deemed to be served. The logic is simple: a person cannot take advantage of their own wrong. By actively refusing the document, they demonstrate an awareness that a formal demand is being made against them.
                  </p>
                  <p className="text-sm md:text-base leading-relaxed">
