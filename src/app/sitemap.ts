...
const STATIC_ROUTES: {
  ...
  { path: "/freelancer-payment-recovery-legal-options-india", changeFrequency: "weekly", priority: 0.85 },
  { path: "/how-freelancer-can-send-legal-notice-to-client-india", changeFrequency: "weekly", priority: 0.85 },
  { path: "/freelancer-consumer-forum-or-civil-court-case-india", changeFrequency: "weekly", priority: 0.85 },
  ...
  { path: "/freelancer-evidence-checklist-payment-recovery-india", changeFrequency: "weekly", priority: 0.85 },
  { path: "/msme-act-freelancer-payment-recovery", changeFrequency: "weekly", priority: 0.85 },
  { path: "/recover-security-deposit-from-landlord-india", changeFrequency: "weekly", priority: 0.85 },
  { path: "/legal-notice-to-landlord-for-security-deposit-refund-india", changeFrequency: "weekly", priority: 0.85 },
