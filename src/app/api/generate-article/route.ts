...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const footerQueryPages = [
      ...
      { title: "What Legal Options Does a Freelancer Have to Recover Dues?", url: "https://www.legalrecovery.in/what-legal-options-does-a-freelancer-in-india-have-to-recover-unpaid-payments-from-a-client" },
      { title: "How Can a Freelancer Send a Legal Notice to a Client?", url: "https://www.legalrecovery.in/how-can-a-freelancer-send-a-legal-notice-to-a-client-who-has-not-paid-for-completed-work-in-india" },
      { title: "Can a Freelancer File a Case in a Consumer Forum?", url: "https://www.legalrecovery.in/can-a-freelancer-file-a-case-in-a-consumer-forum-or-civil-court-to-recover-payment-in-india" },
      { title: "What Evidence Should a Freelancer Collect for Recovery?", url: "https://www.legalrecovery.in/what-evidence-should-a-freelancer-collect-to-strengthen-a-payment-recovery-case-against-a-client" },
      ...
      { title: "Steps to Recover Security Deposit from Refusing Landlord", url: "https://www.legalrecovery.in/what-are-the-legal-steps-to-recover-a-security-deposit-from-a-landlord-who-is-refusing-to-return-it-in-india" },
      { title: "Can I Send a Legal Notice to Landlord for Deposit?", url: "https://www.legalrecovery.in/can-i-send-a-legal-notice-to-my-landlord-for-not-refunding-the-security-deposit-after-vacating-the-property" },
