...
const sections = [
  ...
  },
  {
    ...
    content: `
      ...
      <p class="text-sm md:text-base leading-relaxed"><strong>Step 5: Dispatch and Tracking:</strong> How the notice is sent is as important as what it contains. A legal notice must be sent digitally via verified email and WhatsApp. This generates legally valid tracking receipts and delivery confirmation which serve as the primary proof of service required by courts. The notice should be sent to the borrower’s residential address, and if known, their official workplace address to maximize pressure.</p>
