              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="legal-notice-strategy" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6">
                    ...
                    <p className="text-sm md:text-base leading-relaxed">
                      When we draft a salary recovery legal notice, we address it to the company and name all active directors of the board as individual parties. We obtain their registered residential addresses from the Ministry of Corporate Affairs (MCA) database and dispatch physical copies of the notice via registered speed post directly to their homes, in addition to sending digital copies via official emails and WhatsApp. Naming directors personally is highly effective. It signals that you are prepared to pursue personal liability, which can impact their ability to run other companies, raise funding, or travel abroad. Most directors prefer to resolve the dispute and pay the dues to avoid personal legal complications.
                    </p>
                    <p className="text-sm md:text-base leading-relaxed">
