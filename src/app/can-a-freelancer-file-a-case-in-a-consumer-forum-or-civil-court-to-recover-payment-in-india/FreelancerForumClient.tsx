...
export default function FreelancerForumClient() {
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="civil-court-summary-suits" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-slate-650">
                      ...
                      <li>
                        <strong>Mandatory 10-Day Appearance:</strong> The client (defendant) must enter an appearance in court within exactly **10 days** of receiving the summons. If they fail to appear within this strict timeline, the allegations in the plaint are legally deemed admitted, and the judge will immediately pass a decree in favor of the freelancer.
                      </li>
                      <li>
                        <strong>Summons for Judgment:</strong> If the defendant enters an appearance, the freelancer serves a &quot;Summons for Judgment&quot; (Form 4A, Appendix B). The defendant must then apply to the court for **Leave to Defend** within 10 days of service, supported by an detailed affidavit showing a genuine, triable defense.
                      </li>
                      <li>
                ...
                <section id="msme-samadhaan-facilitation-council" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    <p>
                      For freelancers seeking a powerful alternative to civil courts, the **MSME Samadhaan portal** represents a revolutionary legal option. Under the **Micro, Small and Medium Enterprises Development (MSMED) Act, 2006**, individual professionals, consultants, and independent contractors are eligible to obtain a free online registration called the **Udyam Registration**. Once registered, the freelancer is legally classified as a &quot;Micro Enterprise&quot; in the service sector. This registration unlocks the protective statutory provisions of the MSMED Act, which is specifically designed to protect small suppliers from delayed payments by corporate buyers.
                    </p>
                    <p>
                      The key benefit of the MSMED Act is **Section 15**, which mandates a strict payment timeline. If a registered micro-enterprise supplies services to a buyer (client), the client must make the payment within the period agreed upon in writing. Crucially, the Act specifies that this agreed period **cannot exceed forty-five (45) days** from the date of acceptance of the services. If there is no written agreement, the payment must be made within fifteen (15) days. Any contract clause that attempts to extend the payment timeline beyond 45 days is void under Section 15. If the client fails to clear the invoice within this 45-day window, the freelancer can file an online complaint on the government's MSME Samadhaan portal.
                    </p>
                    <p>
                      The complaint is automatically routed to the local **Micro and Small Enterprise Facilitation Council (MSEFC)**. The MSEFC acts as a specialized quasi-judicial forum and follows a structured two-step process:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-slate-650">
                      <li>
                    ...
                    <p>
                      The most powerful aspect of the MSMED Act is the statutory interest penalty under **Section 16**. If a buyer delays payment beyond the 45-day limit, they are legally obligated to pay the freelancer compound interest with monthly rests on the outstanding amount. The interest rate is fixed at **three times the bank rate** notified by the Reserve Bank of India (RBI). In practice, this rate usually amounts to between **18% and 22% per annum**, which is far higher than the 6% to 9% simple interest typically awarded by civil courts. This interest starts accruing automatically from the day after the 45-day limit expires, creating a massive financial liability for the defaulting client.
                    </p>
                    ...
                    <p>
                      Furthermore, under **Section 19** of the MSMED Act, if the client wishes to appeal an award passed by the MSEFC, the court will not even entertain the appeal unless the client first deposits **75% of the awarded amount** in the court's registry. This provision prevents clients from using appeals to delay payment, as the financial barrier to filing an appeal is extremely high. However, freelancers must note a critical legal requirement: the Udyam Registration **must be active at the time the services were rendered** or before the dispute arose. A retrospective Udyam registration cannot be used to file complaints for past completed works, which is why we advise all Indian freelancers to register on the Udyam portal immediately upon starting their freelance practice.
                    </p>
                  </div>
                </section>
                ...
                <section id="evidentiary-requirements-court" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    ...
                    <p>
                      The legal framework for electronic records is governed by the Information Technology Act, 2000, and the **Bharatiya Sakshya Adhiniyam (BSA), 2023** (which recently replaced the Indian Evidence Act, 1872). Under the Information Technology Act, digital communications such as email threads, Slack messages, WhatsApp chat logs, and project management portals (like Trello, Asana, or Jira) are recognized as legally valid electronic records. If your client approved a scope of work via a WhatsApp chat or a Slack message, that conversation is legally binding. However, you cannot simply print out a screenshot of a WhatsApp chat or print an email and hand it to the judge. The law classifies printouts of electronic records as **secondary electronic evidence**, which is inadmissible unless it meets specific statutory certification requirements.
                    </p>
                    <p>
                      This certification is governed by **Section 63 of the Bharatiya Sakshya Adhiniyam, 2023** (which replaced Section 65B of the Indian Evidence Act). Section 63 mandates that any secondary electronic evidence must be accompanied by a signed **Section 63 BSA Certificate**. This certificate must be signed by a person in a responsible position who manages the device or the system. The certificate must:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-slate-650">
                      <li>
 ...
 Sukshya
                      ...
                      <li>
                        Include the **cryptographic hash values** (such as SHA-256) of the digital files to verify their integrity and prevent any allegation of manipulation.
                      </li>
                    </ul>
                    <p>
                ...
                <section id="pre-suit-legal-notice-prerequisite" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    <p>
                      Before initiating a Summary Suit under Order 37, a regular civil recovery case, or an MSME Samadhaan complaint, there is a crucial, mandatory preliminary step: serving a formal **Pre-Suit Legal Notice** on the defaulting client. A legal notice is a formal communication sent by an advocate on behalf of the freelancer, detailing the facts of the dispute, calculating the exact outstanding dues along with interest, and giving the client a final opportunity (typically **15 days**) to resolve the matter before legal action is initiated.
                    </p>
                    <p>
                ...
                <section id="court-jurisdiction-rules" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    <p>
                      If the 15-day notice period expires and the client fails to respond or refuses to clear the dues, the next step is filing the lawsuit. To do this, the freelancer's legal team must determine the correct court that has the authority to hear the case. This is governed by two distinct legal rules: **Territorial Jurisdiction** (the geographical location of the court) and **Pecuniary Jurisdiction** (the financial value of the claim). Choosing the incorrect jurisdiction will result in the court returning the plaint under Order 7 Rule 10 of the CPC, forcing you to refile the case and causing substantial delays.
                    </p>
                    <p>
                      <strong>Territorial Jurisdiction</strong> is governed by **Section 20 of the Code of Civil Procedure, 1908**. Under Section 20, a civil recovery suit can be filed in a court within the local limits of whose jurisdiction:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-slate-650">
                      <li>
                      ...
                      <li>
                        The **cause of action** arises, wholly or in part. For freelancers, the cause of action is multi-dimensional. It arises where the contract was executed, where the freelancer performed the services (e.g., from their home office), or where the payment was agreed to be made (e.g., the freelancer's bank account location).
                      </li>
                    </ul>
                    <p>
                      Many freelance contracts contain a **&quot;Forum Selection Clause&quot;** (also known as an exclusive jurisdiction clause), which states that any disputes will be subject to the exclusive jurisdiction of the courts in a specific city (e.g., &quot;courts in Mumbai shall have exclusive jurisdiction&quot;). Under Section 28 of the Indian Contract Act, 1872, such clauses are legally valid, provided the chosen city is a place where at least a part of the cause of action arose. However, if the contract is silent, the freelancer has the legal right to file the suit in their own home city, arguing that the contract was performed and the payment was to be received there, which is a significant advantage for the freelancer.
                    </p>
                    <p>
                ...
                <section id="negotiation-and-settlement-deeds" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    ...
                    <p>
                      To prevent this, any settlement must be documented in a formally executed **Settlement Deed** or **Memorandum of Understanding (MOU)**. This deed is a legally binding contract that supersedes the original agreement and must be drafted with precise, protective clauses:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-slate-650">
                      <li>
