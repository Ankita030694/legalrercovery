            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl shadow-sm space-y-12 border border-slate-100">
                ...
                <section id="digital-evidence-bsa-certification" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    <p>
                      Because freelancers operate almost exclusively online, their evidence files consist primarily of digital records—emails, WhatsApp chat logs, Slack screenshots, and Git commits. While the <strong>Information Technology Act, 2000</strong>, recognizes electronic records as legally valid, presenting them in a court trial requires strict adherence to procedural law. Under Indian law, any printout or copy of an electronic record is classified as secondary evidence. To be admissible as evidence, it must strictly comply with the certification rules laid down under <strong>Section 63 of the Bharatiya Sakshya Adhiniyam (BSA), 2023</strong> (which recently replaced Section 65B of the Indian Evidence Act, 1872).
                    </p>
                    <p>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-slate-650">
                      ...
                      <li>
                        The <strong>cryptographic hash values</strong> (such as SHA-256) of the files to verify their integrity and prevent any allegation of manipulation.
                      </li>
                    </ul>
                    <p>
                      When collecting chat evidence, simple screenshots are weak because they do not contain complete metadata and can be easily challenged as manipulated. Instead, freelancers should use the <strong>&quot;Export Chat&quot;</strong> feature in WhatsApp or Slack. This feature generates a complete, unedited text file containing the entire conversation log, dates, times, and phone numbers. If you present this exported file alongside the signed Section 63 BSA Certificate containing its SHA-256 hash, the evidence becomes legally bulletproof. At LegalRecovery, we automatically generate certified digital tracking logs and help prepare Section 63 BSA Certificates for all client communications, protecting your rights in court.
                    </p>
                ...
                <section id="client-default-and-evasion-documentation" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    ...
                    <p>
                      Next, preserve evidence of <strong>active evasion</strong>. If the client has blocked your phone number, deleted the Slack channel, or deactivated your access to the project repository immediately after receiving the final deliverables, take screenshots. If they refuse to take your calls, keep a call log showing the outgoing calls and duration. If you have sent them invoices via platforms that show read receipts, capture those receipts. This trail proves to the court that the client did not have a genuine dispute over quality, but was actively evading their financial liabilities.
                    </p>
                    <p>
                      Finally, perform a <strong>corporate search</strong> to identify the directors and officers behind the business. Under the Companies Act, 2013, if the client is a private limited company, the directors can sometimes be held liable or targeted in legal notices to create pressure. You can extract the company's master data, registered office address, and director names directly from the <strong>Ministry of Corporate Affairs (MCA) portal</strong>. Documenting this corporate structure alongside the evasion log ensures that your legal notice is served directly to the active decision-makers of the company, maximizing your chances of recovery.
                    </p>
                    <div className="bg-red-50 p-6 rounded-2xl border-l-4 border-[#DC2626] italic text-xs sm:text-sm text-red-900 font-semibold leading-relaxed">
                ...
                <section id="pre-suit-demands-and-notices" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    <p>
                      Before a freelancer files a lawsuit in a civil court or approaches the MSME Facilitation Council, they must establish that they gave the client a formal, final opportunity to settle the debt. This is done by serving a <strong>Pre-Suit Legal Notice</strong>. In court, the legal notice and its proof of service are the foundational documents that define your cause of action. If you cannot prove that the notice was successfully served on the client, your case can face severe procedural challenges. Therefore, you must maintain a complete pre-suit communication audit.
                    </p>
                    <p>
                      The audit begins with the notice itself. You must preserve the final signed copy of the notice drafted by your advocate, detailing the specific demand and the 15-day timeline. Next, you must preserve the <strong>proof of dispatch</strong>. When sending a physical notice, it must be sent via <strong>Registered Post AD or Speed Post</strong> through the Indian Post Office. Keep the physical booking receipts containing the unique tracking number (e.g., <code>ED123456789IN</code>). Once the notice is delivered, download and print the official tracking report from the India Post website showing &quot;Item Delivered.&quot;
                    </p>
                    <p>
                      Under <strong>Section 27 of the General Clauses Act, 1897</strong>, if a formal document is sent to the correct address via registered post, the service is legally deemed complete. Even if the client refuses to accept the delivery, or if the postman returns it with the mark &quot;Refused,&quot; the law treats this as <strong>deemed service</strong>. You must preserve the returned, unopened envelope in its original state as evidence of the client's refusal, which acts as a major point of bad faith in court.
                    </p>
                    <p>
                ...
                <section id="quantum-meruit-and-quasi-contract-evidence" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    <p>
                      In cases where a formal contract was never signed, or if the contract was terminated midway, freelancers must rely on the quasi-contractual remedy of <strong>Quantum Meruit</strong> under <strong>Section 70 of the Indian Contract Act, 1872</strong>. This section states that where a person lawfully does anything for another, not intending to do so gratuitously, and the other person enjoys the benefit thereof, the latter is bound to make compensation. However, because there is no formal contract defining the payment terms, the evidentiary standard for Section 70 is exceptionally fact-intensive. The freelancer must prove three statutory conditions with clear, documented evidence.
                    </p>
                    <p>
                      The first condition is proving that the act was <strong>lawful</strong>. You must show that the work was requested by the client and performed in a legitimate business context. You can prove this by presenting email instructions, design briefs, or slack chats where the client explicitly asked you to perform the work. If the client provided you with assets, branding guidelines, or databases to work with, preserve those files. This proves that you did not perform the services unilaterally, but did so at the client's request.
                    </p>
                    <p>
                      The second condition is proving <strong>non-gratuitous intent</strong>—meaning you expected to be paid. In court, the client may attempt to argue that the work was done as a free trial, a pitch, or an internship. To defeat this, you must present price quotes, estimates, or email exchanges where you discussed your rates or invoice policies. If you have a standard rate card published on your website, or if you can show bank statements of past paid projects for the same client, this establishes a clear commercial intent, proving that you never intended to work gratuitously.
                    </p>
                    <p>
                      The third condition is proving that the client <strong>enjoyed the benefit</strong> of your services. This is the core of a Section 70 claim. If you developed a software module and the client integrated it into their live application, provide the live URL and code comparison. If you designed marketing flyers and the client launched them on social media, take screenshots of their active campaigns. Showing that the client has retained your work and is actively using it to generate business value, while refusing to compensate you, establishes <strong>unjust enrichment</strong>. This forces the court to award you reasonable compensation matching the market rate of the services, even without a formal contract.
                    </p>
                  </div>
                </section>
                ...
                <section id="evidence-file-compilation-best-practices" className="scroll-mt-32">
                  ...
                  <div className="prose prose-base max-w-none text-slate-650 space-y-6 text-sm md:text-base leading-relaxed">
                    <p>
                      When a payment dispute occurs, freelancers often make the mistake of sending disorganized, scattered screenshots and files to their advocates, causing significant delays. To ensure a fast-track recovery via a Summary Suit or MSME Facilitation Council, you must compile an organized <strong>Master Evidence File</strong>. This file acts as a structured repository of your case, allowing your legal team to draft the legal notice and prepare the plaint with absolute precision.
                    </p>
                    <p>
