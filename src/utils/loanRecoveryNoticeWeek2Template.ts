...
<div class="notice-body">
  ...
  <p>As per the books of accounts, loan records and electronic records maintained by Our Client, as on <strong>${asOnDate || noticeDate}</strong>, an amount of <strong>Rs. ${formattedAmount} (Rupees ${pendingWords} Only)</strong> ("Outstanding Amount including 2% penalty") remains due and payable by you in respect of Loan ID <strong>${invoiceNo || "__________"}</strong>. The Outstanding Amount comprises the principal outstanding, accrued contractual interest, overdue interest, default interest, penal charges, processing charges, applicable taxes and all other contractual dues payable under the Loan Documents. Your liability continues to increase every day on account of continuing contractual interest, default interest and other applicable contractual charges until full realization.</p>
  ...
  <ol>
    <li>Pay the entire Outstanding Amount (including 2% penalty) of <strong>Rs. ${formattedAmount} (Rupees ${pendingWords} Only)</strong> within Seven (7) days from the date of receipt of this Notice; or</li>
