...
<div class="notice-body">
  ...
  <p>Reference is invited to the loan bearing Loan ID <strong>${invoiceNo || "__________"}</strong>, sanctioned by Our Client on <strong>${invoiceDate || "__________"}</strong> (Sanction Date) for a sum of <strong>&#8377;${formattedAmount} (Rupees ${pendingWords} Only)</strong> and disbursed to you on <strong>${disbursementDate || "__________"}</strong> (Disbursement Date) pursuant to the Loan Agreement, repayment schedule, sanction terms, declarations, mandates, electronic records, and all other ancillary loan documents (collectively referred to as the "Loan Documents"), whether executed physically, electronically, or through any digital mode made available by Our Client.</p>
  ...
  <ol>
    <li>Pay the entire Outstanding Amount of <strong>&#8377;${formattedAmount} (Rupees ${pendingWords} Only)</strong> within Seven (7) days from the date of receipt of this Notice; or</li>
